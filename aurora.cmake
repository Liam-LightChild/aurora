function(a_add_executable name)
    ...
    foreach (file ${ARGN})
        ...
        elseif ("${fext}" STREQUAL ".png" OR
            ...
            add_custom_target("${fdir_u}${fname}${fext}"
                    COMMAND cp ${fabs} "${fdir}${fname}${fext}"
                    SOURCES ${file}
                    DEPENDS "${fdir_u}${fname}${fext}.aet")
            list(APPEND ASSET_DEPENDENCIES "${fdir_u}${fname}${fext}" "${fdir_u}${fname}${fext}.aet")
            list(APPEND ASSET_PATHS_RELATIVE "${fdir}${fname}${fext}" "${fdir}${fname}${fext}.aet")
        else ()
